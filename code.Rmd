...
A mentioned, categorical variables are not included as there is no ranking within these variables. However, a certain type of categorical variables, namely binary variables, do contain a ranking and can be utilised within the KNN-model. Our initial model included the binary variables and this yielded the following results:
