...
Moreover, it should be kept in mind that how well a KNN-model works can decline when too many feature are added to the model. These points are all kept in mind in specifying the recipe for the KNN-model.
```{r}
# Specify model 
knn_mod <- 
